...
<div class="text-centre container">
    <div class="row">
        <div class="col-lg-12">
    </br>
            <h1 class="text-center mb-3"><b>CONTACT US</b></h1>
    </br>
    </br>
                        ...
                        <div class="col-md-8">
                            <table class="table" style="font-size: 20px;">
                                <tr>
                                    ...
                                    <td><b>Pincode   : </b>522502</td>
                                </tr>
                                <tr>
                                    <td>SRM University</td>
                                    <td><b>Phone no :</b> +91 8008020932</td>
                                </tr>
                                <tr>
                                    <td>Neerukonda , Mangalgiri </td>
                                    <td><b>Email ID  : </b>lavanya05072004@gmail.com</td>
                                </tr>
                            </table>
                        </div>
